...
public class SportNews {
    public static String getSportNews(ModelITNews model) throws IOException {
        URL url = new URL("https://newsapi.org/v2/top-headlines?q=medal&apiKey=c4d37aaecdc5475d83813414e39c973d");
