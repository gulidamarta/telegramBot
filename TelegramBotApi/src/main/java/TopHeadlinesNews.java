...
public class TopHeadlinesNews {
    public static String getTopHeadlinesNews(String message, ModelITNews model) throws IOException {
        URL url = new URL("https://newsapi.org/v2/top-headlines" +
                "?country=us&" +
                "apiKey=c4d37aaecdc5475d83813414e39c973d");
